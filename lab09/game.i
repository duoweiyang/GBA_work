...
void updatePlayer() {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<7)))) {
        if (pikachu.worldRow + pikachu.height < 256
            && collisionmapBitmap[((pikachu.worldRow + pikachu.height + pikachu.rdel - 1)*(256)+(pikachu.worldCol))]
            && collisionmapBitmap[((pikachu.worldRow + pikachu.height + pikachu.rdel - 1)*(256)+(pikachu.worldCol + pikachu.width - 1))]
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<4)))) {
        if (pikachu.worldCol + pikachu.width < 256
            && collisionmapBitmap[((pikachu.worldRow)*(256)+(pikachu.worldCol + pikachu.width + pikachu.cdel - 1))]
            && collisionmapBitmap[((pikachu.worldRow + pikachu.height - 1)*(256)+(pikachu.worldCol + pikachu.width + pikachu.cdel - 1))]
