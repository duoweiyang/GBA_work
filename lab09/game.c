...
void updatePlayer() {
    ...
    if(BUTTON_HELD(BUTTON_UP)) {
        if (pikachu.worldRow > 0   
            && collisionmapBitmap[OFFSET(pikachu.worldRow - pikachu.rdel, pikachu.worldCol, MAPWIDTH)]
            && collisionmapBitmap[OFFSET(pikachu.worldRow - pikachu.rdel, pikachu.worldCol + pikachu.width - 1, MAPWIDTH)] /*Delete that 1, then:
    ...
    if(BUTTON_HELD(BUTTON_DOWN)) {
        if (pikachu.worldRow + pikachu.height < 256  
            && collisionmapBitmap[OFFSET(pikachu.worldRow + pikachu.height + pikachu.rdel - 1, pikachu.worldCol, MAPWIDTH)]
            && collisionmapBitmap[OFFSET(pikachu.worldRow + pikachu.height + pikachu.rdel - 1, pikachu.worldCol + pikachu.width - 1, MAPWIDTH)] /*Delete that 1, then:
            for TODO 1.0, make sure pikachu doesn't go off the map here,
            for TODO 2.2, check collision map here as well*/) {
    ...
    if(BUTTON_HELD(BUTTON_LEFT)) {
        if (pikachu.worldCol > 0   
            && collisionmapBitmap[OFFSET(pikachu.worldRow, pikachu.worldCol - pikachu.cdel, MAPWIDTH)]
            && collisionmapBitmap[OFFSET(pikachu.worldRow + pikachu.height - 1, pikachu.worldCol - pikachu.cdel, MAPWIDTH)] /*Delete that 1, then:
            for TODO 1.0, make sure pikachu doesn't go off the map here,
            for TODO 2.2, check collision map here as well*/) {
    ...
    if(BUTTON_HELD(BUTTON_RIGHT)) {
        if (pikachu.worldCol + pikachu.width < 256    
            && collisionmapBitmap[OFFSET(pikachu.worldRow, pikachu.worldCol + pikachu.width + pikachu.cdel - 1, MAPWIDTH)]
            && collisionmapBitmap[OFFSET(pikachu.worldRow + pikachu.height - 1, pikachu.worldCol + pikachu.width + pikachu.cdel - 1, MAPWIDTH)]
         /*Delete that 1, then:
            for TODO 1.0, make sure pikachu doesn't go off the map here,
            for TODO 2.2, check collision map here as well*/) {
