/* Cart Surfer from Club Penguin but simplified. 
No tricks unfortunately, but you get points by leaning left or right 
for longer periods of time. Press enter to start, pause, restart when game is over.
Press A to go through the instruction screens.
Press B to activate cheat.
*/ 
